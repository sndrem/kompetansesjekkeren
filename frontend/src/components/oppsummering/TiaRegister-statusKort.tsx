...
function TiaRegisterStatusKort(props: Props) {
  const registernavn = "Teleinstallatørautorisasjoner";
  ...
  const tekst = data
    ? `${data.firmanavn} har teleinstallatørautorisasjon ✅`
    : `${orgnr} har ingen teleinstallatørautorisasjon ❌.`;
  return (
    <Kort
      size={props.size}
      tittel={registernavn}
...
export default TiaRegisterStatusKort;
